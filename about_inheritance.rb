...
class AboutInheritance < Neo::Koan
  ...
  class BullDog < Dog
    def bark
      super + ", GROWL"
        # The super keyword is used to call the same method (with the same name) 
        # defined in the superclass of the current class. In this example, BullDog 
        # is a subclass of Dog. When you call super within the bark method of BullDog, 
        # it invokes the bark method of the superclass (Dog).
    end
  end
