...
class AboutScope < Neo::Koan
  ...
  #   A NameError is an exception in Ruby that occurs 
  #   when you try to reference a variable or a constant 
  #   that hasn't been defined or is out of scope. This 
  #   error indicates that Ruby couldn't find the name 
  #   you referenced.
  end
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
    # The .constants method is used to retrieve an array containing 
    # the names of all the constants defined in a module or class. 
