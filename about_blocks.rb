...
class AboutBlocks < Neo::Koan
  def method_with_block
    # the yield keyword is used within a method definition to execute a block of code that is passed to the method
    result = yield
    result
  end
  ...
  def test_methods_can_call_yield_many_times
    ...
    # my guess = [:peanut, :butter, :and, :jelly]
