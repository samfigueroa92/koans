...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Describe in your own words what inject does.
      # inject is an alias for reduce; in this example it is adding/multiplying 
      # all the following elements to the indicated sum total defaults are 0 & 1
  end
  ...
  # When you get to the "AboutSandwichCode" koan, recheck your answer.
      ...
      # Answer: The File.open option is better because it ensures that the file is 
      # closed automatically after the block execution. This is important 
      # for managing system resources efficiently, especially when dealing 
      # with potentially large numbers of files or when working in environments 
